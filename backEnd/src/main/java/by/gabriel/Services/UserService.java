...
public class UserService {
    ...
    public Usuario realizarLogin(Usuario usuario) {
        ...
        //Verifico se o campo nome está nulo ou (||) se o nome está vazio ou se contem somente espaços
        if (usuario.getNome() == null || usuario.getNome().trim().isBlank()) {
          ...
          //Verifico se o campo senha está nula ou (||) se a senha está vazio ou se contem somente espaços
        ...
        try {
            ...
            //Verificando no banco se o status esta como desativado
    ...
    public Usuario cadastroUser(Usuario usuario) {
        ...
        // Remove espaços extras do nome (apenas início/fim)
        ...
        try {
            ...
            Usuario cadastrado = dao.cadastroUser(usuario);
            ...
            throw new IllegalStateException("Erro ao inserir os dados " + e.getMessage(), e);
        } 
        catch (Exception e) {
